...
import { getStudents, updateStudent } from "@/features/student/services/student.service";
...
import type { Teacher, UpdateTeacherPayload } from "@/features/teacher/types/teacher.types";
import { useNotificationStore } from "@/features/notification/store/notificationStore";
import { toast } from "sonner";
import { User, Phone, MapPin, Mail, BookOpen, Save, Shield } from "lucide-react";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {user?.role === "TEACHER" && (
              <>
                ...
                <div>
                  <label className="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-1.5 flex items-center gap-2">
                    <BookOpen className="h-4 w-4 text-slate-400" /> Department (Managed by Admin)
                  </label>
                  <input
                    type="text"
                    value={department}
                ...
                <div>
                  <label className="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-1.5 flex items-center gap-2">
                    <BookOpen className="h-4 w-4 text-slate-400" /> Subject (Managed by Admin)
                  </label>
                  <input
                    type="text"
                    value={subject}
                ...
                <div>
                  <label className="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-1.5 flex items-center gap-2">
                    <BookOpen className="h-4 w-4 text-slate-400" /> Highest Qualification
                  </label>
                  <input
                    type="text"
                    value={qualification}
                ...
                <div>
                  <label className="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-1.5 flex items-center gap-2">
                    <User className="h-4 w-4 text-slate-400" /> Experience (Years)
                  </label>
                  <input
                    type="number"
